                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="/pembelian/{{ $dataPembelian->id }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            @if($dataPembelian->gambar != null)
                            <img src="{{ url('images/buktiPembayaran/'.$dataPembelian->gambar) }}" id="img-view" style="" class="max-h-64 w-96 mb-2 object-cover">
                            @endif
