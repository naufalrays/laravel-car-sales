<x-app-layout>
    ...
    <div class="py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="/pemesanan/{{ $dataPemesanan->id }}/konfirmasiPembayaran" method="post">
                @csrf
                <div class="p-6 grid grid-cols-2 grid-flow-col gap-6 items-center   text-gray-900 dark:text-gray-100">
                    ...
                    <div>
                        ...
                        <div id="text-field-container" style="display: block;" class="mt-6 mb-6">
                            ...
                            <input type="text" name="alasan_batal" id="alasan_batal" value="Gambar Tidak Jelas" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" placeholder="Alasan Dibatalkan" required>
                        </div>
                    </div>
                </div>
            </form>
